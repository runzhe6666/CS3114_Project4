...
public class Handler {
	 ...
	 */
	public Handler(int initBlocksize, int initCapacity) {
		myDb = new Database(initBlocksize);
		artistHash = new HashTable(initCapacity);
		songHash = new HashTable(initCapacity);
	...
	public boolean insert(String artist, String song) {
		...
		if (artistSongTree.find(artistSongPair) == null) { // not a duplicate
			...
			System.out.println("The KVPair (|" + artist + "|,|" + song + "|),(" + artistHandle + "," + songHandle
					+ ") is added to the tree.");
			System.out.println("The KVPair (|" + song + "|,|" + artist + "|),(" + songHandle + "," + artistHandle
					+ ") is added to the tree.");
			return true;
		}
	...
	public boolean delete(String artist, String song) {
		...
		if (artistSongTree.find(artistSongPair) == null) {
			System.out.println("The KVPair (|" + artist + "|,|" + song + "|) was not found in the database.");
			System.out.println("The KVPair (|" + song + "|,|" + artist + "|) was not found in the database.");
			return false;
		}
